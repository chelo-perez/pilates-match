...
const styles = StyleSheet.create({
  ...
  bannerText:           { fontFamily: 'DMSans-SemiBold', fontSize: 13, color: '#633806', flex: 1 },
  ...
  avatarLetter:         { fontFamily: 'DMSans-SemiBold', fontSize: 17, color: colors.sage },
  instrName:            { fontFamily: 'DMSans-SemiBold', fontSize: 14, color: colors.dark },
  ...
  countdownText:        { fontFamily: 'DMSans-SemiBold', fontSize: 11, color: colors.mid },
  ...
  evalBtnText:          { fontFamily: 'DMSans-SemiBold', fontSize: 14, color: colors.white },
})
