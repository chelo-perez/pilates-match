...
const styles = StyleSheet.create({
  ...
  table: { backgroundColor: colors.white, borderTopLeftRadius: 20, borderTopRightRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 20, overflow: 'hidden', marginBottom: spacing.xl, borderWidth: 0.5, borderColor: colors.border },
  ...
  infoBox: { backgroundColor: colors.goldLight, borderTopLeftRadius: 14, borderTopRightRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 14, padding: spacing.md, borderWidth: 0.5, borderColor: colors.gold },
