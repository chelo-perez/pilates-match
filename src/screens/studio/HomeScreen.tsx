...
const styles = StyleSheet.create({
  ...
  studioName:     { fontFamily: 'PlayfairDisplay-Medium', fontSize: 24, color: colors.dark },
  ...
  blockTitle:     { fontFamily: 'DMSans-SemiBold', fontSize: 13, color: '#633806' },
  ...
  kpiNum:         { fontFamily: 'DMSans-SemiBold', fontSize: 26, color: colors.dark },
  ...
  searchBtnText:  { fontFamily: 'DMSans-SemiBold', fontSize: 15, color: colors.white },
  ...
  instrName:      { fontFamily: 'DMSans-SemiBold', fontSize: 13, color: colors.dark },
  ...
  evalBtnText:    { fontFamily: 'DMSans-SemiBold', fontSize: 11, color: colors.sage },
  seeAll:         { paddingVertical: spacing.sm, alignItems: 'center' },
  seeAllText:     { fontFamily: 'DMSans-SemiBold', fontSize: 12, color: colors.sage },
})
