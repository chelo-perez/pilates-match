...
const styles = StyleSheet.create({
  ...
  filterBtn:       { paddingHorizontal: spacing.md, paddingVertical: spacing.xs, borderRadius: radius.full, backgroundColor: colors.white, borderWidth: 0.5, borderColor: colors.border },
  filterActive:    { backgroundColor: colors.sage, borderColor: colors.sage },
  filterText:      { ...typography.small, color: colors.mid, fontFamily: 'DM_Sans-SemiBold' },
  ...
  avatarLetter:    { fontFamily: 'DM_Sans-SemiBold', fontSize: 18, color: colors.sage },
  info:            { flex: 1 },
  ...
  memberDetail:    { backgroundColor: colors.cream, borderRadius: radius.sm, padding: spacing.sm, marginBottom: spacing.sm },
  detailRow:       { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 2 },
  detailLabel:     { ...typography.small, color: colors.mid },
  detailVal:       { ...typography.small, color: colors.dark, fontFamily: 'DM_Sans-SemiBold' },
  noMemberText:    { ...typography.small, color: colors.light },
  actionBtn:       { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, paddingVertical: spacing.sm, borderRadius: radius.md, borderWidth: 1 },
  actionAdd:       { borderColor: colors.sage, backgroundColor: colors.sageLight },
  actionRemove:    { borderColor: '#F09595', backgroundColor: '#FCEBEB' },
  actionText:      { fontFamily: 'DM_Sans-SemiBold', fontSize: 13 },
})
