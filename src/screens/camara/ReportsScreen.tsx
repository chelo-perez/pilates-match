...
const styles = StyleSheet.create({
  ...
  periodText:        { fontFamily: 'DMSans-SemiBold', fontSize: 11, color: colors.mid },
  ...
  rLetter:           { fontFamily: 'DMSans-SemiBold', fontSize: 14, color: colors.sage },
  rName:             { fontFamily: 'DMSans-SemiBold', fontSize: 13, color: colors.dark },
  ...
  reportBadgeText:   { fontFamily: 'DMSans-SemiBold', fontSize: 10, color: '#633806' },
  rankBadge:         { backgroundColor: colors.sageLight, borderRadius: radius.sm, paddingHorizontal: spacing.sm, paddingVertical: 3 },
  rankNum:           { fontFamily: 'DMSans-SemiBold', fontSize: 11, color: colors.sage },
})
