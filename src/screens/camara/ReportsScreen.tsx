...
const styles = StyleSheet.create({
  ...
  kpiCard:           { flex: 1, minWidth: '45%', backgroundColor: colors.white, borderTopLeftRadius: 14, borderTopRightRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 14, padding: spacing.md, borderWidth: 0.5, borderColor: colors.borderLight },
  ...
  reportBadge:       { backgroundColor: '#FAEEDA', borderTopLeftRadius: 8, borderTopRightRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 8, paddingHorizontal: spacing.sm, paddingVertical: 3 },
  reportBadgeText:   { fontFamily: 'Nunito-SemiBold', fontSize: 10, color: '#633806' },
  rankBadge:         { backgroundColor: colors.sageLight, borderTopLeftRadius: 8, borderTopRightRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 8, paddingHorizontal: spacing.sm, paddingVertical: 3 },
