            ...
            recentEvals.map((item: any) => (
              <View key={item.id} style={s.evalRow}>
                <View style={s.evalLeft}>
                  ...
                  {item.comment && (
                    <Text style={s.evalComment}>"{item.comment}"</Text>
                  )}
                </View>
...
const s = StyleSheet.create({
  ...
  header:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: spacing.md, paddingTop: spacing.lg },
