...
const s = StyleSheet.create({
  ...
  avatarEdit:         { position: 'absolute', bottom: 0, right: 0, width: 24, height: 24, borderRadius: 12, backgroundColor: colors.sage, borderWidth: 2, borderColor: colors.white, alignItems: 'center', justifyContent: 'center' },
  ...
  selector:           { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', height: 48, borderWidth: 0.5, borderColor: colors.border, borderRadius: 14, paddingHorizontal: spacing.md, backgroundColor: colors.cream, marginBottom: spacing.md },
  ...
  addBtn:             { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: colors.sageLight, paddingHorizontal: spacing.sm, paddingVertical: 5, borderRadius: 8 },
  ...
  fileNote:           { flexDirection: 'row', gap: spacing.xs, alignItems: 'flex-start', backgroundColor: colors.cream, borderRadius: 8, padding: spacing.sm, marginBottom: spacing.md },
