...
const styles = StyleSheet.create({
  ...
  studioLetter: { fontFamily: 'DMSans-SemiBold', fontSize: 18, color: colors.sage },
  studioName:   { fontFamily: 'DMSans-SemiBold', fontSize: 15, color: colors.dark },
  ...
  anonText:     { ...typography.small, color: colors.sage, fontFamily: 'DMSans-SemiBold' },
